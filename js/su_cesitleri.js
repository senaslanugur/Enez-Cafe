...
for(var k = 0; k < dat.prodcuts.length; k++){
  hst.innerHTML += '<div class="col mb-4"> <div class="card h-50"><img class="card-img-top" src="'+(dat.prodcuts[k].photo_name)+'" alt="..." /><div class="card-body p-4"><div class="text-center"><h6 class="fw-bolder">'
